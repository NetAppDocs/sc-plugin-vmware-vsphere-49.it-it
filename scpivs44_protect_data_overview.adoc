...
Si consiglia di consultare le informazioni relative alle funzioni del plug-in VMware di SnapCenter e non supportato.
link:scpivs44_deployment_planning_and_requirements.html["Pianificazione e requisiti dell'implementazione"]
