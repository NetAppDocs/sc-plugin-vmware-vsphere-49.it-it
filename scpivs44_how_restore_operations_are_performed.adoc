...
| VM e VMDK | Backup primari | Ambienti NFS: ONTAP Single file SnapRestore
Ambienti VMFS: Clonare e montare con Storage VMotion 


| VM e VMDK | Backup secondari | Ambienti NFS: ONTAP Single file SnapRestore
Ambienti VMFS: Clonare e montare con Storage VMotion 


| Macchine virtuali e VMDK eliminati | Backup primari | Ambienti NFS: ONTAP Single file SnapRestore
Ambienti VMFS: Clonare e montare con Storage VMotion 


| Macchine virtuali e VMDK eliminati | Backup secondari | Ambienti NFS: Clonare e montare con Storage VMotion
Ambienti VMFS: Clonare e montare con Storage VMotion 


| VM e VMDK | Backup primari coerenti con le macchine virtuali | Ambienti NFS: ONTAP Single file SnapRestore
Ambienti VMFS: Clonare e montare con Storage VMotion 


| VM e VMDK | Backup secondari coerenti con le macchine virtuali | Ambienti NFS: Clonare e montare con Storage VMotion
Ambienti VMFS: Clonare e montare con Storage VMotion 
...
Ambienti NFS:
* ONTAP Single file SnapRestore se si utilizza ONTAP versione 9.10.1 e successive
* Clone e montaggio con Storage VMotion sulle versioni precedenti di ONTAP
