...
| Ripristinare il percorso | Immettere il percorso di condivisione UNC per il guest in cui verranno ripristinati i file selezionati.
Esempio IPv4: `\\10.60.136.65\c$`
Esempio IPv6: `\\fd20-8b1e-b255-832e--61.ipv6-literal.net\C\restore` 
...
| Disconnettere Guest
Sessione dopo
ripristino riuscito | Selezionare questa opzione se si desidera che la sessione di ripristino del file guest venga eliminata al termine dell'operazione di ripristino. 
|===
